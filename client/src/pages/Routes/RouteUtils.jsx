...
const showSideBarPG = () => {
  return (
    ...
    window.location.pathname === "/PostgreSQL/select-into" ||
    window.location.pathname === "/PostgreSQL/create-table-as" ||
    window.location.pathname === "/PostgreSQL/serial"
  );
};
const showSideBarJS = () => {
  return (
...
export { showSideBarJS, showSideBarPG, notShowNavBar };
