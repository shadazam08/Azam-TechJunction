    ...
    <>
      ...
      <Box component={"main"} className="changeWidth">
        ...
        <Box sx={{ p: 3 }}>
          ...
          <Typography component={"p"} align={"justify"} mt={2}>
            Second, use the <code className="codes">CREATE DATABASE</code>{" "}
            statement to create a new database named{" "}
            <code className="codes">dvdrental</code>:
          </Typography>
          <Grid container spacing={2} sx={{ padding: "0.2em" }}>
            <Grid xs={12}>
          ...
          <Typography component={"p"} align={"justify"} mt={2}>
            Third, verify the creation of the database by using the{" "}
            <code className="codes">\l</code> command. This command will list
            all the databases on the PostgreSQL server:
          </Typography>
          <Grid container spacing={2} sx={{ padding: "0.2em" }}>
            <Grid xs={12}>
              <Typography
...
-- More  --`}</code>
          ...
          <Typography component={"p"} align={"justify"} mt={2}>
            The output includes <code className="codes">dvdrental</code> in the
            list, indicating that the <code className="codes">dvdrental</code>{" "}
            database has been successfully created.
          </Typography>
          <Typography component={"p"} align={"justify"} mt={2}>
            Note that databases like <code className={"codes"}>postgres</code>,{" "}
            <code className={"codes"}>template0</code>, and{" "}
            <code className={"codes"}>template1</code> are system databases.
          </Typography>
          <Typography component={"p"} align={"justify"} mt={2}>
            Fourth, disconnect from the PostgreSQL server and exit{" "}
            <code className={"codes"}>psql</code> by using the{" "}
            <code className={"codes"}>\q</code> or{" "}
            <code className={"codes"}>\exit</code> command:
          </Typography>
          <Grid container spacing={2} sx={{ padding: "0.2em" }}>
            <Grid xs={12}>
              <Typography
...
\\exit`}</code>
          ...
          <Typography align={"justify"} sx={{ fontSize: "24px" }} mt={2}>
            <strong>
              ...
              {")"} Restore the sample database from a{" "}
              <code className="codes">tar</code> archive
            </strong>
          </Typography>
          <Typography component={"p"} align={"justify"} mt={2}>
            Fifth, download the sample database{" "}
            <code className="codes">{"(dvdrental.zip)"}</code> and extract the
            tar file to the directory such as{" "}
            <code className="codes">C:\dvdrental\dvdrental.tar</code> on
            Windows.
          </Typography>
          <Typography component={"p"} align={"justify"} mt={2}>
            In this command:
          ...
          <List>
            <ListItem>
              <Typography component={"span"} align="justify">
                ...
                The <code className="codes">-U postgres</code> instructs{" "}
                <code className="codes">pg_restore</code> to connect the
                PostgreSQL server using the{" "}
            ...
            <ListItem>
              <Typography component={"span"} align="justify">
                ...
                The <code className="codes">-d dvdrental</code> specifies the
                target database to load.
              </Typography>
            </ListItem>
          </List>
          <Typography component={"p"} align={"justify"} mt={2}>
            It’ll prompt you to enter the password for the{" "}
            <code className="codes">postgres</code> user. Enter the password for
            the <code className="codes">postgres</code> user and press the Enter
            (or Return key):
          </Typography>
          <Grid container spacing={2} sx={{ padding: "0.2em" }}>
            <Grid xs={12}>
          ...
          <Typography component={"p"} align={"justify"} mt={2}>
            It’ll take about seconds to load data stored in the{" "}
            <code className="codes">dvdrental.tar</code> file into the{" "}
          ...
          <Typography component={"p"} align={"justify"} mt={2}>
            ...
            <code className="codes">psql</code> command:
          </Typography>
          <Grid container spacing={2} sx={{ padding: "0.2em" }}>
            <Grid xs={12}>
              <Typography
          ...
          <Typography component={"p"} align={"justify"} mt={2}>
            Third, display all tables in the{" "}
            <code className="codes">dvdrental</code> database:
          </Typography>
          <Grid container spacing={2} sx={{ padding: "0.2em" }}>
            <Grid xs={12}>
